...
def test_end_to_end_trade_lifecycle():
    ...
    validation_engine = PreTradeValidationEngine()
    ...
    # PortfolioRiskEngine needs an active
    # position value.
    position[
        "capital"
    ] = order[
    ...
    # Risk protection is handled by PortfolioRiskEngine.
    ...
    # -------------------------------------------------
    # High-risk portfolio evaluation
    # -------------------------------------------------
